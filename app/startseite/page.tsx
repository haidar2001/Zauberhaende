...
export const metadata: Metadata = {
  ...
  description:
    "Änderungsschneiderei in Alfter bei Bonn, Bornheim & Wesseling: Hosenkürzen, Kleideränderungen & Textilreinigung - nur 14 Min. von Bonn und 10 Min. von Bornheim entfernt",
  keywords:
