...
export const metadata: Metadata = {
  ...
  description:
    "Ihre Änderungsschneiderei in Alfter bei Bonn & Bornheim: Maßgeschneiderte Änderungen, Hosenkürzen, Kleideranpassungen und Textilreinigung - nur wenige Minuten von Bonn und Bornheim entfernt.",
  keywords:
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
            <article className="relative">
              <div className="bg-background rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-muted-foreground text-center leading-relaxed">
                  Besuchen Sie uns in Alfter. Wir beraten Sie kostenlos und
            ...
            <article className="relative">
              <div className="bg-background rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-muted-foreground text-center leading-relaxed">
                  Wir kümmern uns mit höchster Sorgfalt um Ihre Textilien - schnell, präzise und mit Qualitätsgarantie
                </p>
              </div>
              <div className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-1/2 z-10">
                <ArrowRight className="h-8 w-8 text-accent" />
            ...
            <article>
              <div className="bg-background rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-muted-foreground text-center leading-relaxed">
                  Holen Sie Ihre perfekt angepassten oder gereinigten Textilien ab.
                </p>
              </div>
            </article>
          </div>
